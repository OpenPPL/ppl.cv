...
foreach(KERNEL_FILE0 IN ITEMS ${KERNEL_FILES})
    ...
    string(REGEX MATCH "[0-9A-Za-z]*.cl$" KERNEL_FILE1 ${KERNEL_FILE0})
    # message("KERNEL_FILE1 file: ${KERNEL_FILE1}")
    file(STRINGS ${KERNEL_FILE0} CONTENT_STRING NEWLINE_CONSUME)
    string(HEX ${CONTENT_STRING} CONTENT_HEX0)
    string(REGEX REPLACE "(.)(.)" "0x\\1\\2, " CONTENT_HEX1 ${CONTENT_HEX0})
    # message("CONTENT_HEX1 file: ${CONTENT_HEX1}")
    set(KERNEL_STRING "static const char source_string[] = {${CONTENT_HEX1}0x00}\;")
    file(WRITE ${CMAKE_CURRENT_BINARY_DIR}/kernels/${KERNEL_FILE1} ${KERNEL_STRING})
endforeach()
