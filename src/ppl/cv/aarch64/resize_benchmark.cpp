...
public:
    ...
    void apply()
    {
        if (mode == ppl::cv::INTERPOLATION_TYPE_LINEAR) {
            ppl::cv::aarch64::ResizeLinear<T, channels>(this->inHeight,
                                                        this->inWidth,
            ...
            ppl::cv::aarch64::ResizeNearestPoint<T, channels>(this->inHeight,
                                                              this->inWidth,
                                                              this->inWidth * channels,
                                                              this->dev_iImage,
                                                              this->outHeight,
            ...
            ppl::cv::aarch64::ResizeArea<T, channels>(this->inHeight,
                                                      this->inWidth,
                                                      this->inWidth * channels,
                                                      this->dev_iImage,
                                                      this->outHeight,
