    ...
    uint8_t borderValue)
{
    ...
    if (border_type == BORDER_TYPE_CONSTANT) {
        ...
        remap_linear_uchar<1, BORDER_TYPE_REPLICATE>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_TRANSPARENT) {
        remap_linear_uchar<1, BORDER_TYPE_TRANSPARENT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    }
    ...
    uint8_t borderValue)
{
    ...
    if (border_type == BORDER_TYPE_CONSTANT) {
        ...
        remap_linear_uchar<3, BORDER_TYPE_REPLICATE>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_TRANSPARENT) {
        remap_linear_uchar<3, BORDER_TYPE_TRANSPARENT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    }
    return ppl::common::RC_SUCCESS;
}
    ...
    uint8_t borderValue)
{
    ...
    if (border_type == BORDER_TYPE_CONSTANT) {
        ...
        remap_linear_uchar<4, BORDER_TYPE_REPLICATE>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_TRANSPARENT) {
        remap_linear_uchar<4, BORDER_TYPE_TRANSPARENT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    }
    return ppl::common::RC_SUCCESS;
}
    ...
    uint8_t borderValue)
{
    ...
    if (border_type == BORDER_TYPE_CONSTANT) {
        remap_nearest_uchar<1, BORDER_TYPE_CONSTANT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_REPLICATE) {
        remap_nearest_uchar<1, BORDER_TYPE_REPLICATE>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_TRANSPARENT) {
        remap_nearest_uchar<1, BORDER_TYPE_TRANSPARENT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    }
    return ppl::common::RC_SUCCESS;
}
    ...
    uint8_t borderValue)
{
    ...
    if (border_type == BORDER_TYPE_CONSTANT) {
        remap_nearest_uchar<3, BORDER_TYPE_CONSTANT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_REPLICATE) {
        remap_nearest_uchar<3, BORDER_TYPE_REPLICATE>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_TRANSPARENT) {
        remap_nearest_uchar<3, BORDER_TYPE_TRANSPARENT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    }
    return ppl::common::RC_SUCCESS;
}
    ...
    uint8_t borderValue)
{
    ...
    if (border_type == BORDER_TYPE_CONSTANT) {
        remap_nearest_uchar<4, BORDER_TYPE_CONSTANT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_REPLICATE) {
        remap_nearest_uchar<4, BORDER_TYPE_REPLICATE>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    } else if (border_type == BORDER_TYPE_TRANSPARENT) {
        remap_nearest_uchar<4, BORDER_TYPE_TRANSPARENT>(inHeight, inWidth, inWidthStride, inData, outHeight, outWidth, outWidthStride, outData, mapx, mapy, borderValue);
    }
    return ppl::common::RC_SUCCESS;
}
