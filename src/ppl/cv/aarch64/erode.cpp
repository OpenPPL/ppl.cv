...
::ppl::common::RetCode armminFilter_f(int height, int width, int inWidthStride, const float* inData, int kernelx_len, int kernely_len, int outWidthStride, float* outData, int cn, float border_value)
{
...
template <typename T>
::ppl::common::RetCode armminFilter_normal(int height, int width, int inWidthStride, const T* inData, int kernelx_len, int kernely_len, const uchar* kernel, int outWidthStride, T* outData, int cn, T border_value)
{
    T minimal;
...
#define Erode(dt, nc, name)                                                                                                                                                                                                           \
    template <>                                                                                                                                                                                                                       \
    ::ppl::common::RetCode Erode<dt, nc>(int height, int width, int inWidthStride, const dt* inData, int kernelx_len, int kernely_len, const uchar* kernel, int outWidthStride, dt* outData, BorderType border_type, dt border_value) \
    {                                                                                                                                                                                                                                 \
        assert(inData != NULL);                                                                                                                                                                                                       \
        assert(outData != NULL);                                                                                                                                                                                                      \
        assert(kernel != NULL);                                                                                                                                                                                                       \
