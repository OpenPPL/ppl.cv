...
#define R(name, t, ic, oc, mode, diff)\
    ...
    INSTANTIATE_TEST_CASE_P(standard, name,\
        ::testing::Combine(::testing::Values(Size{320, 256}, Size{720, 480}),\
                           ::testing::Values(mode),\
                           ::testing::Values(diff)));
