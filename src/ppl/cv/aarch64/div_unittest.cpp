...
void DivTest(int32_t height, int32_t width)
{
    ...
    ppl::cv::aarch64::Div<T, nc>(height, width, width * nc, src0.get(), width * nc, src1.get(), width * nc, dst.get());
...
TEST(DivTest, aarch64)
{
    DivTest<float, 1>(640, 720);
    DivTest<float, 3>(640, 720);
    DivTest<float, 4>(640, 720);
    DivTest<uint8_t, 1>(640, 720);
    DivTest<uint8_t, 3>(640, 720);
    DivTest<uint8_t, 4>(640, 720);
}
