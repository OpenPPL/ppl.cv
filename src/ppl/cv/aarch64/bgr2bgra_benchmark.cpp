...
public:
    ...
    void BGR2BGRAapply()
    {
        ppl::cv::aarch64::BGR2BGRA<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    ...
    void BGRA2BGRapply()
    {
        ppl::cv::aarch64::BGRA2BGR<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
