...
public:
    ...
    void BGR2GRAYapply()
    {
        ppl::cv::aarch64::BGR2GRAY<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    void GRAY2BGRapply()
    {
        ppl::cv::aarch64::GRAY2BGR<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    void BGRA2GRAYapply()
    {
        ppl::cv::aarch64::BGRA2GRAY<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    void GRAY2BGRAapply()
    {
        ppl::cv::aarch64::GRAY2BGRA<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
};
} // namespace
template <typename T, int32_t input_channels, int32_t output_channels>
