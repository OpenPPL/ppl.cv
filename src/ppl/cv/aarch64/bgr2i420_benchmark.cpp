...
public:
    ...
    void BGR2I420apply()
    {
        ppl::cv::aarch64::BGR2I420<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    ...
    void I4202BGRapply()
    {
        ppl::cv::aarch64::I4202BGR<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    ...
    void BGRA2I420apply()
    {
        ppl::cv::aarch64::BGRA2I420<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
    ...
    void I4202BGRAapply()
    {
        ppl::cv::aarch64::I4202BGRA<T>(height, width, width * input_channels, dev_iImage, width * output_channels, dev_oImage);
    }
