...
#include "ppl/cv/aarch64/copymakeborder.h"
...
R(copymakeborder_u8c4_constant_aarch64, uint8_t, 4, ppl::cv::BORDER_TYPE_CONSTANT, 1.01f);
R(copymakeborder_u8c1_replicate_aarch64, uint8_t, 1, ppl::cv::BORDER_TYPE_REPLICATE, 1.01f);
R(copymakeborder_u8c3_replicate_aarch64, uint8_t, 3, ppl::cv::BORDER_TYPE_REPLICATE, 1.01f);
R(copymakeborder_u8c4_replicate_aarch64, uint8_t, 4, ppl::cv::BORDER_TYPE_REPLICATE, 1.01f);
R(copymakeborder_u8c1_reflect_aarch64, uint8_t, 1, ppl::cv::BORDER_TYPE_REFLECT, 1.01f);
R(copymakeborder_u8c3_reflect_aarch64, uint8_t, 3, ppl::cv::BORDER_TYPE_REFLECT, 1.01f);
R(copymakeborder_u8c4_reflect_aarch64, uint8_t, 4, ppl::cv::BORDER_TYPE_REFLECT, 1.01f);
R(copymakeborder_u8c1_reflect101_aarch64, uint8_t, 1, ppl::cv::BORDER_TYPE_REFLECT_101, 1.01f);
R(copymakeborder_u8c3_reflect101_aarch64, uint8_t, 3, ppl::cv::BORDER_TYPE_REFLECT_101, 1.01f);
R(copymakeborder_u8c4_reflect101_aarch64, uint8_t, 4, ppl::cv::BORDER_TYPE_REFLECT_101, 1.01f);

R(copymakeborder_fp32c1_constant_aarch64, float, 1, ppl::cv::BORDER_TYPE_CONSTANT, 1.01f);
R(copymakeborder_fp32c3_constant_aarch64, float, 3, ppl::cv::BORDER_TYPE_CONSTANT, 1.01f);
R(copymakeborder_fp32c4_constant_aarch64, float, 4, ppl::cv::BORDER_TYPE_CONSTANT, 1.01f);
R(copymakeborder_fp32c1_replicate_aarch64, float, 1, ppl::cv::BORDER_TYPE_REPLICATE, 1.01f);
R(copymakeborder_fp32c3_replicate_aarch64, float, 3, ppl::cv::BORDER_TYPE_REPLICATE, 1.01f);
R(copymakeborder_fp32c4_replicate_aarch64, float, 4, ppl::cv::BORDER_TYPE_REPLICATE, 1.01f);
R(copymakeborder_fp32c1_reflect_aarch64, float, 1, ppl::cv::BORDER_TYPE_REFLECT, 1.01f);
R(copymakeborder_fp32c3_reflect_aarch64, float, 3, ppl::cv::BORDER_TYPE_REFLECT, 1.01f);
R(copymakeborder_fp32c4_reflect_aarch64, float, 4, ppl::cv::BORDER_TYPE_REFLECT, 1.01f);
