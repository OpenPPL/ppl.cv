...
#define Erode(dt, nc, name)                                                                                                                                                                                                                                     \
    ...
    {                                                                                                                                                                                                                                                           \
        ...
        if (flag && flag3)                                                                                                                                                                                                                                      \
            ppl::cv::arm::morph_##name<ErodeVecOp, nc, 3>(height, width, inWidthStride, inData, outWidthStride, outData, ppl::cv::BORDER_TYPE_CONSTANT, border_value);                                                                                      \
        else if (flag && flag5)                                                                                                                                                                                                                                 \
            ppl::cv::arm::morph_##name<ErodeVecOp, nc, 5>(height, width, inWidthStride, inData, outWidthStride, outData, ppl::cv::BORDER_TYPE_CONSTANT, border_value);                                                                                      \
        else                                                                                                                                                                                                                                                    \
