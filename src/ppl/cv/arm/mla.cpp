...
::ppl::common::RetCode mla_f32(int32_t height,
                               int32_t width,
                               int32_t channels,
                               ...
                               float32_t *outData)
{
    ...
    for (int32_t i = 0; i < height; ++i) {
        ...
        for (; j <= width - 8; j += 8) {
            ...
            voutData0 = vmlaq_f32(voutData0, vdata0, vdata1);
            voutData1 = vmlaq_f32(voutData1, vdata2, vdata3);
        ...
        for (; j <= width - 4; j += 4) {
            ...
            voutData = vmlaq_f32(voutData, vdata0, vdata1);
...
template <>
::ppl::common::RetCode Mla<float, 1>(int32_t height,
                                     int32_t width,
                                     int32_t inWidthStride0,
                                     const float32_t *inData0,
                                     int32_t inWidthStride1,
                                     ...
                                     float32_t *outData)
{
    return mla_f32(height, width, 1, inWidthStride0, inData0, inWidthStride1, inData1, outWidthStride, outData);
}

template <>
::ppl::common::RetCode Mla<float, 3>(int32_t height,
                                     int32_t width,
                                     int32_t inWidthStride0,
                                     const float32_t *inData0,
                                     int32_t inWidthStride1,
                                     ...
                                     float32_t *outData)
{
    return mla_f32(height, width, 3, inWidthStride0, inData0, inWidthStride1, inData1, outWidthStride, outData);
}

template <>
::ppl::common::RetCode Mla<float, 4>(int32_t height,
                                     int32_t width,
                                     int32_t inWidthStride0,
                                     const float32_t *inData0,
                                     int32_t inWidthStride1,
                                     ...
                                     float32_t *outData)
{
    return mla_f32(height, width, 4, inWidthStride0, inData0, inWidthStride1, inData1, outWidthStride, outData);
}
