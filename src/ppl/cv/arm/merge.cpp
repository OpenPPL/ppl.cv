...
template <typename T>
void mergeSOA2AOS(int32_t numChannels,
                  int32_t height,
                  int32_t width,
                                      ...
                                      T* outData)
{
    ...
    mergeSOA2AOS<T>(3, height, width, inWidthStride, inData, outWidthStride, outData);
                                      ...
                                      T* outData)
{
    ...
    mergeSOA2AOS<T>(4, height, width, inWidthStride, inData, outWidthStride, outData);
    return ppl::common::RC_SUCCESS;
}
