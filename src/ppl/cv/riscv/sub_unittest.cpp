...
void SubTest(int32_t height, int32_t width)
{
...
TEST(SUB_FP32, riscv)
{
    SubTest<float, 1>(640, 720);
    SubTest<float, 3>(640, 720);
    SubTest<float, 4>(640, 720);
}

TEST(SUB_INT8, riscv)
{
    SubTest<uint8_t, 1>(640, 720);
    SubTest<uint8_t, 3>(640, 720);
    SubTest<uint8_t, 4>(640, 720);
}
