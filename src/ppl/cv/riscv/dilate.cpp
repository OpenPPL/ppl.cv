...
#define Dilate(dt, nc, name)                                                                                                                                                                                                                                     \
    ...
    {                                                                                                                                                                                                                                                            \
        ...
        if (border_type == BORDER_CONSTANT) {                                                                                                                                                                                                                    \
            return morph<dt, MORPH_DILATE, BORDER_CONSTANT, nc>(height, width, inWidthStride, inData, kernelx_len, kernely_len, kernel, outWidthStride, outData, border_value);                                                                                  \
        } else if (border_type == BORDER_REPLICATE) {                                                                                                                                                                                                            \
            return morph<dt, MORPH_DILATE, BORDER_REPLICATE, nc>(height, width, inWidthStride, inData, kernelx_len, kernely_len, kernel, outWidthStride, outData, border_value);                                                                                 \
        } else if (border_type == BORDER_REFLECT) {                                                                                                                                                                                                              \
            return morph<dt, MORPH_DILATE, BORDER_REFLECT, nc>(height, width, inWidthStride, inData, kernelx_len, kernely_len, kernel, outWidthStride, outData, border_value);                                                                                   \
        } else if (border_type == BORDER_REFLECT101) {                                                                                                                                                                                                           \
            return morph<dt, MORPH_DILATE, BORDER_REFLECT101, nc>(height, width, inWidthStride, inData, kernelx_len, kernely_len, kernel, outWidthStride, outData, border_value);                                                                                \
        } else {                                                                                                                                                                                                                                                 \
