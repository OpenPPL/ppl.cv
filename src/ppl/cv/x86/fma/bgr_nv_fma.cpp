...
template ::ppl::common::RetCode nv_2_rgb<3, 0, true>(
    int32_t height,
    int32_t width,
    int32_t inYStride,
    const uchar *inY,
...
template ::ppl::common::RetCode nv_2_rgb<3, 2, true>(
    int32_t height,
    int32_t width,
    int32_t inYStride,
    const uchar *inY,
...
template ::ppl::common::RetCode nv_2_rgb<3, 0, false>(
    int32_t height,
    int32_t width,
    int32_t inYStride,
    const uchar *inY,
...
template ::ppl::common::RetCode nv_2_rgb<3, 2, false>(
    int32_t height,
    int32_t width,
    int32_t inYStride,
    const uchar *inY,
