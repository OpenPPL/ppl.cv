...
/**
 * @file   flip_unittest.cpp
 * @brief  test suites for image flipping operation. It uses the google test.
 */
...
using PplCvCudaFlipTest ## T ## channels =                                     \
        PplCvCudaFlipTest<T, channels>;                                        \
