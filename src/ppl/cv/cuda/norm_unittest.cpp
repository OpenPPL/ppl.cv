...
bool PplCvCudaNormTest<T, channels>::apply() {
  ...
  // std::cout << "Opencv Norm result: " << result0 << std::endl;
  // std::cout << "Ppl.cv.norm result: " << result1 << std::endl;
  // std::cout << "Ppl.cv.norm result: " << result2 << std::endl;
  // Opencv Norm result: 3097806.38479, Ppl.cv.norm result: 3097806.5
...
INSTANTIATE_TEST_CASE_P(IsEqual, PplCvCudaNormTest ## T ## channels,           \
  ::testing::Combine(                                                          \
    ::testing::Values(NORM_L1, NORM_L2, NORM_INF),                             \
