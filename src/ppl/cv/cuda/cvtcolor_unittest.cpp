/**
 * @file   cvtcolor_unittest.cpp
 * @brief  test suites for color space conversion functions. It uses the google
 *         test.
 * @note   The counterparts in OpenCV or ppl.cv.x86 are compared.
