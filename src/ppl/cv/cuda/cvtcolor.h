/**
 * @file   cvtcolor.h
 * @brief  Interface declarations of color space conversion functions.
 * @author Liheng Jian(jianliheng@sensetime.com)
 *
 * @copyright Copyright (c) 2014-2021 SenseTime Group Limited.
 */

#ifndef _ST_HPC_PPL3_CV_CUDA_CVTCOLOR_H_
#define _ST_HPC_PPL3_CV_CUDA_CVTCOLOR_H_
 ...
 */
template <typename T>
ppl::common::RetCode BGR2UYVY(cudaStream_t stream,
                              int height,
                              int width,
                              int inWidthStride,
                              const T* inData,
...
#endif  // _ST_HPC_PPL3_CV_CUDA_CVTCOLOR_H_
