...
// RUN_BENCHMARK1(uchar, 27, BORDER_TYPE_REPLICATE, 640, 480)
// RUN_BENCHMARK1(uchar, 27, BORDER_TYPE_REFLECT, 640, 480)
// RUN_BENCHMARK1(uchar, 27, BORDER_TYPE_REFLECT_101, 640, 480)
...
// RUN_BENCHMARK1(float, 27, BORDER_TYPE_REPLICATE, 640, 480)
// RUN_BENCHMARK1(float, 27, BORDER_TYPE_REFLECT, 640, 480)
// RUN_BENCHMARK1(float, 27, BORDER_TYPE_REFLECT_101, 640, 480)
...
RUN_PPL_CV_TYPE_FUNCTIONS(uchar, 11, BORDER_TYPE_REPLICATE)
RUN_PPL_CV_TYPE_FUNCTIONS(uchar, 11, BORDER_TYPE_REFLECT)
RUN_PPL_CV_TYPE_FUNCTIONS(uchar, 11, BORDER_TYPE_REFLECT_101)
RUN_PPL_CV_TYPE_FUNCTIONS(float, 11, BORDER_TYPE_REPLICATE)
RUN_PPL_CV_TYPE_FUNCTIONS(float, 11, BORDER_TYPE_REFLECT)
RUN_PPL_CV_TYPE_FUNCTIONS(float, 11, BORDER_TYPE_REFLECT_101)

RUN_PPL_CV_TYPE_FUNCTIONS(uchar, 21, BORDER_TYPE_REPLICATE)
RUN_PPL_CV_TYPE_FUNCTIONS(uchar, 21, BORDER_TYPE_REFLECT)
RUN_PPL_CV_TYPE_FUNCTIONS(uchar, 21, BORDER_TYPE_REFLECT_101)
RUN_PPL_CV_TYPE_FUNCTIONS(float, 21, BORDER_TYPE_REPLICATE)
RUN_PPL_CV_TYPE_FUNCTIONS(float, 21, BORDER_TYPE_REFLECT)
RUN_PPL_CV_TYPE_FUNCTIONS(float, 21, BORDER_TYPE_REFLECT_101)
