...
RUN_OPENCV_TYPE_FUNCTIONS(uchar, INTERPOLATION_LINEAR, BORDER_CONSTANT)
RUN_OPENCV_TYPE_FUNCTIONS(uchar, INTERPOLATION_LINEAR, BORDER_REPLICATE)
RUN_OPENCV_TYPE_FUNCTIONS(uchar, INTERPOLATION_LINEAR, BORDER_TRANSPARENT)
RUN_OPENCV_TYPE_FUNCTIONS(uchar, INTERPOLATION_NEAREST_POINT, BORDER_CONSTANT)
RUN_OPENCV_TYPE_FUNCTIONS(uchar, INTERPOLATION_NEAREST_POINT, BORDER_REPLICATE)
RUN_OPENCV_TYPE_FUNCTIONS(uchar, INTERPOLATION_NEAREST_POINT, 
                          BORDER_TRANSPARENT)
RUN_OPENCV_TYPE_FUNCTIONS(float, INTERPOLATION_LINEAR, BORDER_CONSTANT)
RUN_OPENCV_TYPE_FUNCTIONS(float, INTERPOLATION_LINEAR, BORDER_REPLICATE)
RUN_OPENCV_TYPE_FUNCTIONS(float, INTERPOLATION_LINEAR, BORDER_TRANSPARENT)
RUN_OPENCV_TYPE_FUNCTIONS(float, INTERPOLATION_NEAREST_POINT, BORDER_CONSTANT)
RUN_OPENCV_TYPE_FUNCTIONS(float, INTERPOLATION_NEAREST_POINT, BORDER_REPLICATE)
RUN_OPENCV_TYPE_FUNCTIONS(float, INTERPOLATION_NEAREST_POINT, 
                          BORDER_TRANSPARENT)

RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(uchar, INTERPOLATION_LINEAR, BORDER_CONSTANT)
RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(uchar, INTERPOLATION_LINEAR, BORDER_REPLICATE)
RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(uchar, INTERPOLATION_LINEAR, BORDER_TRANSPARENT)
...
RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(uchar, INTERPOLATION_NEAREST_POINT,
                               BORDER_TRANSPARENT)
RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(float, INTERPOLATION_LINEAR, BORDER_CONSTANT)
RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(float, INTERPOLATION_LINEAR, BORDER_REPLICATE)
RUN_PPL_CV_CUDA_TYPE_FUNCTIONS(float, INTERPOLATION_LINEAR, BORDER_TRANSPARENT)
