...
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k9x9, 640, 480, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k15x15, 640, 480, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k3x3, 640, 480, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k5x5, 640, 480, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k9x9, 640, 480, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k15x15, 640, 480, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k3x3, 1920, 1080, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k5x5, 1920, 1080, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k9x9, 1920, 1080, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k15x15, 1920, 1080, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k3x3, 1920, 1080, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k5x5, 1920, 1080, kDilate)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k9x9, 1920, 1080, kDilate)
...
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k9x9, 640, 480, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k15x15, 640, 480, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k3x3, 640, 480, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k5x5, 640, 480, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k9x9, 640, 480, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k15x15, 640, 480, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k3x3, 1920, 1080, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k5x5, 1920, 1080, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k9x9, 1920, 1080, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k15x15, 1920, 1080, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k3x3, 1920, 1080, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k5x5, 1920, 1080, kDilate)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k9x9, 1920, 1080, kDilate)
...
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k9x9, 640, 480, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k15x15, 640, 480, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k3x3, 640, 480, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k5x5, 640, 480, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k9x9, 640, 480, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k15x15, 640, 480, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k3x3, 1920, 1080, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k5x5, 1920, 1080, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k9x9, 1920, 1080, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(uchar, k15x15, 1920, 1080, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k3x3, 1920, 1080, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k5x5, 1920, 1080, kErode)
// RUN_OPENCV_TYPE_FUNCTIONS(float, k9x9, 1920, 1080, kErode)
...
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k9x9, 640, 480, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k15x15, 640, 480, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k3x3, 640, 480, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k5x5, 640, 480, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k9x9, 640, 480, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k15x15, 640, 480, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k3x3, 1920, 1080, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k5x5, 1920, 1080, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k9x9, 1920, 1080, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(uchar, k15x15, 1920, 1080, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k3x3, 1920, 1080, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k5x5, 1920, 1080, kErode)
// RUN_PPL_CV_TYPE_FUNCTIONS(float, k9x9, 1920, 1080, kErode)
