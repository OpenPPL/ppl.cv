...
#define ADAPTIVETHRESHOLD_MEANF32U8C1KERNEL(interpolate)                       \
__kernel                                                                     \
void adaptivethreshold_meanF32U8##interpolate##C1Kernel(                     \
...
#define ADAPTIVETHRESHOLD_MEANU8F32C1KERNEL(interpolate)                       \
__kernel                                                                     \
void adaptivethreshold_meanU8F32##interpolate##C1Kernel(                     \
    global const uchar* src_input, int src_input_stride,                     \
...
#define ADAPTIVETHRESHOLD_GAUSSIANBLURF32U8C1KERNEL(interpolate)               \
__kernel                                                                     \
void adaptivethreshold_gaussianblurF32U8##interpolate##C1Kernel(             \
    global const uchar* src_input, int src_input_stride,                     \
...
#define ADAPTIVETHRESHOLD_GAUSSIANBLURU8F32C1KERNEL(interpolate)               \
__kernel                                                                     \
void adaptivethreshold_gaussianblurU8F32##interpolate##C1Kernel(             \
    global const uchar* src_input, int src_input_stride,                     \
...
ADAPTIVETHRESHOLD_MEANF32U8C1KERNEL(interpolateReplicateBorder)
ADAPTIVETHRESHOLD_MEANU8F32C1KERNEL(interpolateReplicateBorder)
#endif
#if defined(ADAPTIVETHRESHOLD_interpolateReplicateBorderGAUSSIANBLUE)
ADAPTIVETHRESHOLD_GAUSSIANBLURF32U8C1KERNEL(interpolateReplicateBorder)
ADAPTIVETHRESHOLD_GAUSSIANBLURU8F32C1KERNEL(interpolateReplicateBorder)
#endif

#if defined(ADAPTIVETHRESHOLD_interpolateReflectBorderMEAN)
ADAPTIVETHRESHOLD_MEANF32U8C1KERNEL(interpolateReflectBorder)
ADAPTIVETHRESHOLD_MEANU8F32C1KERNEL(interpolateReflectBorder)
#endif
#if defined(ADAPTIVETHRESHOLD_interpolateReflectBorderGAUSSIANBLUE)
ADAPTIVETHRESHOLD_GAUSSIANBLURF32U8C1KERNEL(interpolateReflectBorder)
ADAPTIVETHRESHOLD_GAUSSIANBLURU8F32C1KERNEL(interpolateReflectBorder)
#endif

#if defined(ADAPTIVETHRESHOLD_interpolateReflect101BorderMEAN)
ADAPTIVETHRESHOLD_MEANF32U8C1KERNEL(interpolateReflect101Border)
ADAPTIVETHRESHOLD_MEANU8F32C1KERNEL(interpolateReflect101Border)
#endif
#if defined(ADAPTIVETHRESHOLD_interpolateReflect101BorderGAUSSIANBLUE)
ADAPTIVETHRESHOLD_GAUSSIANBLURF32U8C1KERNEL(interpolateReflect101Border)
ADAPTIVETHRESHOLD_GAUSSIANBLURU8F32C1KERNEL(interpolateReflect101Border)
#endif
