...
void BM_WarpPerspective_ppl_ocl(benchmark::State &state) {
  ...
  for (int i = 0; i < iterations; i++) {
    ppl::cv::ocl::WarpPerspective<T, channels>(queue, src.rows, src.cols,
...
template <typename T, int channels, ppl::cv::InterpolationType inter_type,
          ppl::cv::BorderType border_type>
void BM_WarpPerspective_opencv_ocl(benchmark::State &state) {
  int src_width  = state.range(0);
  int src_height = state.range(1);
  int dst_width  = state.range(2);
  int dst_height = state.range(3);
...
#define RUN_BENCHMARK(channels, inter_type, src_width, src_height, dst_width,  \
                      dst_height)                                              \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, channels, inter_type, \
                   ppl::cv::BORDER_CONSTANT)->Args({src_width, src_height,     \
                   dst_width, dst_height});                                    \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, channels, inter_type,    \
                   ppl::cv::BORDER_CONSTANT)->Args({src_width, src_height,     \
...
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, channels, inter_type,    \
                   ppl::cv::BORDER_TRANSPARENT)->Args({src_width, src_height,  \
                   dst_width, dst_height})->UseManualTime()->Iterations(10);   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, channels, inter_type, \
                   ppl::cv::BORDER_CONSTANT)->Args({src_width, src_height,     \
                   dst_width, dst_height});                                    \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, channels, inter_type,    \
                   ppl::cv::BORDER_CONSTANT)->Args({src_width,  src_height,    \
                   dst_width, dst_height})->UseManualTime()->Iterations(10);   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, channels, inter_type, \
                   ppl::cv::BORDER_REPLICATE)->Args({src_width, src_height,    \
...
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, c1, inter_type,       \
                   border_type)->Args({640, 480, 320, 240});                   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, c1, inter_type,       \
                   border_type)->Args({640, 480, 1280, 960});                  \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, c3, inter_type,       \
                   border_type)->Args({640, 480, 320, 240});                   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, c3, inter_type,       \
                   border_type)->Args({640, 480, 1280, 960});                  \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, c4, inter_type,       \
                   border_type)->Args({640, 480, 320, 240});                   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, uchar, c4, inter_type,       \
                   border_type)->Args({640, 480, 1280, 960});                  \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, c1, inter_type,       \
                   border_type)->Args({640, 480, 320, 240});                   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, c1, inter_type,       \
                   border_type)->Args({640, 480, 1280, 960});                  \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, c3, inter_type,       \
                   border_type)->Args({640, 480, 320, 240});                   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, c3, inter_type,       \
                   border_type)->Args({640, 480, 1280, 960});                  \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, c4, inter_type,       \
                   border_type)->Args({640, 480, 320, 240});                   \
BENCHMARK_TEMPLATE(BM_WarpPerspective_opencv_ocl, float, c4, inter_type,       \
                   border_type)->Args({640, 480, 1280, 960});

#define RUN_PPL_FUNCTIONS(inter_type, border_type)                             \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, c1,  inter_type,         \
                   border_type)->Args({640, 480, 320, 240})->                  \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, c1,  inter_type,         \
                   border_type)->Args({640, 480, 1280, 960})->                 \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, c3,  inter_type,         \
                   border_type)->Args({640, 480, 320, 240})->                  \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, c3,  inter_type,         \
                   border_type)->Args({640, 480, 1280, 960})->                 \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, c4,  inter_type,         \
                   border_type)->Args({640, 480, 320, 240})->                  \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, uchar, c4,  inter_type,         \
                   border_type)->Args({640, 480, 1280, 960})->                 \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, c1,  inter_type,         \
                   border_type)->Args({640, 480, 320, 240})->                  \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, c1,  inter_type,         \
                   border_type)->Args({640, 480, 1280, 960})->                 \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, c3,  inter_type,         \
                   border_type)->Args({640, 480, 320, 240})->                  \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, c3,  inter_type,         \
                   border_type)->Args({640, 480, 1280, 960})->                 \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, c4,  inter_type,         \
                   border_type)->Args({640, 480, 320, 240})->                  \
                   UseManualTime()->Iterations(10);                            \
BENCHMARK_TEMPLATE(BM_WarpPerspective_ppl_ocl, float, c4,  inter_type,         \
                   border_type)->Args({640, 480, 1280, 960})->                 \
