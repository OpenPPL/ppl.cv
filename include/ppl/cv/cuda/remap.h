...
#ifndef _ST_HPC_PPL3_CV_CUDA_REMAP_H_
#define _ST_HPC_PPL3_CV_CUDA_REMAP_H_
 ...
 *   RemapLinear<float, 3>(stream, src_height, src_width,
...
ppl::common::RetCode RemapLinear(cudaStream_t stream,
                                  int inHeight,
                                  int inWidth,
                                  int inWidthStride,
                                  const T* inData,
 ...
 *   cudaStream_t stream;
 *   cudaStreamCreate(&stream);
 *   RemapNearestPoint<float, 3>(stream, src_height, src_width,
 *                               input_pitch / sizeof(float), dev_input,
 *                               dst_height, dst_width,
 *                               output_pitch / sizeof(float), dev_output,
 *                               dev_map_x, dev_map, y);
...
template <typename T, int channels>
ppl::common::RetCode 
RemapNearestPoint(cudaStream_t stream,
                  int inHeight,
                  int inWidth,
                  int inWidthStride,
                  const T* inData,
...
#endif  // _ST_HPC_PPL3_CV_CUDA_REMAP_H_
