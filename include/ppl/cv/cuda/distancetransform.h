...
#ifndef _ST_HPC_PPL3_CV_CUDA_DISTANCETRANSFORM_H_
#define _ST_HPC_PPL3_CV_CUDA_DISTANCETRANSFORM_H_
 ...
 *   DistanceTransformMasks mask_size = ppl::cv::DIST_MASK_5;
 *
 *   uchar* dev_input;
 *   float* dev_output;
...
#endif  // _ST_HPC_PPL3_CV_CUDA_DISTANCETRANSFORM_H_
