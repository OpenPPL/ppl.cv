 ...
 *         recommended.
 *       2 The size of the output image is computed as ((height+1)/2, (width+1)/2).
 ...
 *                     input_pitch / sizeof(float), dev_input, dst_height,
 *                     dst_width, output_pitch / sizeof(float), dev_output);
