...
#ifndef _ST_HPC_PPL3_CV_CUDA_EQUALIZEHIST_H_
#define _ST_HPC_PPL3_CV_CUDA_EQUALIZEHIST_H_
 ...
 *   EqualizeHist(stream, height, width, input_pitch / sizeof(uchar), dev_input,
...
#endif  // _ST_HPC_PPL3_CV_CUDA_EQUALIZEHIST_H_
