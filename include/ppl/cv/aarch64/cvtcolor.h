 ...
 * <tr><td> Header files<td> #include &lt;ppl/cv/aarch64/cvtcolor.h&gt;
 ...
 *     
 *     ppl::cv::aarch64::BGR2BGRA<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::BGRA2BGR<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::RGB2GRAY<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::GRAY2RGB<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::RGBA2GRAY<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::GRAY2RGBA<float, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::BGR2GRAY<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::GRAY2BGR<float>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::BGRA2GRAY<float, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     float* dev_oImage = (float*)malloc(W * H * output_channels * sizeof(float));
 *     
 *     ppl::cv::aarch64::GRAY2BGRA<float, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     
 *     ppl::cv::aarch64::BGR2I420<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     ppl::cv::aarch64::BGR2I420<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, 
 ...
 *     
 *     ppl::cv::aarch64::I4202BGR<uint8_t, 1, 3>(H, W, W, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202BGR<uint8_t, 1, 3>(H, W, yStride, dev_iImage_y, uStride, dev_iImage_u, vStride, dev_iImage_v, 
 ...
 *     
 *     ppl::cv::aarch64::RGB2I420<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     ppl::cv::aarch64::RGB2I420<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, 
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202RGB<uint8_t, 1, 3>(H, W, W, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202RGB<uint8_t, 1, 3>(H, W, yStride, dev_iImage_y, uStride, dev_iImage_u, vStride, dev_iImage_v, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_u);
 *     free(dev_iImage_v);
 ...
 *     
 *     ppl::cv::aarch64::BGRA2I420<uint_8, 4, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     ppl::cv::aarch64::BGRA2I420<uint_8, 4, 1>(H, W, W * input_channels, dev_iImage, yStride, dev_oImage_y, uStride, dev_oImage_u, vStride, dev_oImage_v);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_u);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202BGRA<uint8_t, 1, 4>(H, W, W, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202BGRA<uint8_t, 1, 4>(H, W, yStride, dev_iImage_y, uStride, dev_iImage_u, vStride, dev_iImage_v, w*output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_u);
 *     free(dev_iImage_v);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::RGBA2I420<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint_8* dev_oImage_u = (uint_8*)malloc(W * H / 4 * sizeof(uint_8));
 *     uint_8* dev_oImage_v = (uint_8*)malloc(W * H / 4 * sizeof(uint_8));
 *     ppl::cv::aarch64::RGBA2I420<uint_8, 4, 1>(H, W, W * input_channels, dev_iImage, yStride, dev_oImage_y, uStride, dev_oImage_u, vStride, dev_oImage_v);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_u);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202RGBA<uint8_t, 1, 4>(H, W, W, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::I4202RGBA<uint8_t, 1, 4>(H, W, yStride, dev_iImage_y, uStride, dev_iImage_u, vStride, dev_iImage_v, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_u);
 *     free(dev_iImage_v);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *
 *     ppl::cv::aarch64::BGR2YV12<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::YV122BGR<uint8_t, 1, 3>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::RGB2YV12<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::YV122RGB<uint8_t, 1, 3>(H, W, W, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint_8* dev_oImage = (uint_8*)malloc(W * H * sizeof(uint_8) * 3 / 2);
 *
 *     ppl::cv::aarch64::BGRA2YV12<uint_8, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::YV122BGRA<uint8_t, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *
 *     ppl::cv::aarch64::RGBA2YV12<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::YV122RGBA<uint8_t, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::BGR2NV12<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     ppl::cv::aarch64::BGR2NV12<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_uv);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122BGR<uint8_t, 1, 3>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122BGR<uint8_t, 1, 3>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_uv);
 *     free(dev_oImage);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::BGRA2NV12<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage_uv = (uint8_t*)malloc(W * H / 2 * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::BGRA2NV12<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_uv);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122BGRA<uint8_t, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122BGRA<uint8_t, 1, 4>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_uv);
 *     free(dev_oImage);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::BGR2NV21<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage_uv = (uint8_t*)malloc(W * H / 2 * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::BGR2NV21<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_uv);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212BGR<uint8_t, 1, 3>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::NV212BGR<uint8_t, 1, 3>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_uv);
 *     free(dev_oImage);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::BGRA2NV21<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage_y = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
  *     uint8_t* dev_oImage_uv = (uint8_t*)malloc(W * H / 2 * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::BGRA2NV21<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212BGRA<uint8_t, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212BGRA<uint8_t, 1, 4>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_uv);
 *     free(dev_oImage);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::RGB2NV12<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage_y = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     uint8_t* dev_oImage_uv = (uint8_t*)malloc(W * H / 2 * sizeof(uint8_t));
 *     ppl::cv::aarch64::RGB2NV12<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_uv);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *
 *     ppl::cv::aarch64::NV122RGB<uint8_t, 1, 3>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122RGB<uint8_t, 1, 3>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_uv);
 *     free(dev_oImage);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::RGBA2NV12<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     ppl::cv::aarch64::RGBA2NV12<uint8_t, 4, 1>(H, W, W, dev_oImage_y, W, dev_oImage_vu,  W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);  
 *     free(dev_oImage_vu);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122RGBA<uint8_t, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV122RGBA<uint8_t, 1, 4>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage_y);
 *     free(dev_iImage_uv);
 *     free(dev_oImage);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *     
 *     ppl::cv::aarch64::RGB2NV21<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage_y = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     uint8_t* dev_oImage_uv = (uint8_t*)malloc(W * H / 2 * sizeof(uint8_t));
 *     ppl::cv::aarch64::RGB2NV21<uint8_t, 3, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212RGB<uint8_t, 1, 3>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212RGB<uint8_t, 1, 3>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * sizeof(uint8_t) * 3 / 2);
 *
 *     ppl::cv::aarch64::RGBA2NV21<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage_y = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     uint8_t* dev_oImage_uv = (uint8_t*)malloc(W * H / 2 * sizeof(uint8_t));
 *     ppl::cv::aarch64::RGBA2NV21<uint8_t, 4, 1>(H, W, W * input_channels, dev_iImage, W, dev_oImage_y, W, dev_oImage_uv);
 *
 *     free(dev_iImage);
 *     free(dev_oImage_y);
 *     free(dev_oImage_uv);
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212RGBA<uint8_t, 1, 4>(H, W, W * input_channels, dev_iImage, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
 ...
 *     uint8_t* dev_oImage = (uint8_t*)malloc(W * H * output_channels * sizeof(uint8_t));
 *     
 *     ppl::cv::aarch64::NV212RGBA<uint8_t, 1, 4>(H, W, W, dev_iImage_y, W, dev_iImage_uv, W * output_channels, dev_oImage);
 *
 *     free(dev_iImage);
 *     free(dev_oImage);
 *     return 0;
