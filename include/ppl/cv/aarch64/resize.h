...
* <tr><td>Header files<td> #include &lt;ppl/cv/aarch64/resize.h&gt;
* <tr><td>Project<td> ppl.cv
* @since ppl.cv-v1.0.0
* ###Example
* @code{.cpp}
* #include <ppl/cv/aarch64/resize.h>
...
*
*     ppl::cv::aarch64::ResizeNearestPoint<float, 3>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage);
*
*     free(dev_iImage);
*     free(dev_oImage);
*     return 0;
...
*     float* dev_oImage = (float*)malloc(W * H * C * sizeof(float));
*
*     ppl::cv::aarch64::ResizeLinear<float, 3>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage);
*
*     free(dev_iImage);
*     return 0;
* }
...
*     float* dev_oImage = (float*)malloc(W * H * C * sizeof(float));
*
*     ppl::cv::aarch64::ResizeArea<float, 3>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage);
*
*     free(dev_iImage);
*     free(dev_oImage);
*     return 0;
