 ...
 * <tr><td>Header files<td> #include &lt;ppl/cv/aarch64/copymakeborder.h&gt;
 ...
 * 
 *     ppl::cv::aarch64::CopyMakeBorder<uint8_t, 3>(srcH, srcW, srcW * C, dev_iImage, dstH, dstW, dstW * C, dev_oImage, 
