...
* <tr><td>Header files<td> #include &lt;ppl/cv/aarch64/warpaffine.h&gt;
...
*
*     ppl::cv::aarch64::WarpAffineNearestPoint<float, 4>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage, affineMatrix, ppl::cv::BORDER_TYPE_CONSTANT);
*
*     free(dev_iImage);
*     free(dev_oImage);
*     return 0;
...
*     float* affineMatrix = (float*)malloc(6 * sizeof(float));
*
*     ppl::cv::aarch64::WarpAffineLinear<float, 4>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage, affineMatrix, ppl::cv::BORDER_TYPE_CONSTANT);
*
*     free(dev_iImage);
*     free(dev_oImage);
*     return 0;
