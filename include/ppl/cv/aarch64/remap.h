...
* <tr><td>Header files<td> #include &lt;ppl/cv/aarch64/remap.h&gt;
...
*
*     ppl::cv::aarch64::RemapLinear<unsigend char, 3>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage, mapX, mapY, ppl::cv::BORDER_TYPE_CONSTANT);
*
*     free(dev_iImage);
*     free(dev_oImage);
*     free(mapX);
...
*     float* mapY= (float*)malloc(outWidth * outHeight * sizeof(float));
*
*     ppl::cv::aarch64::RemapNearestPoint<unsigend char, 3>(inHeight, inWidth, inWidth * C, dev_iImage, outHeight, outWidth, outWidth * C, dev_oImage, mapX, mapY, ppl::cv::BORDER_TYPE_CONSTANT);
*
*     free(dev_iImage);
*     free(dev_oImage);
*     free(mapX);
