...
* <tr><td>Header files<td> #include &lt;ppl/cv/aarch64/get_affine_transform.h&gt;
* <tr><td>Project<td> ppl.cv
* @since ppl.cv-v1.0.0
* ###Example
* @code{.cpp}
* #include <ppl/cv/aarch64/get_affine_transform.h>
...
*
*     ppl::cv::aarch64::GetAffineTransform(src_points, dst_points, mat, inverse_mat);
*     return 0;
* }
* @endcode
***************************************************************************************************/
