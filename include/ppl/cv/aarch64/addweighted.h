...
* <tr><td>Header files<td> #include &lt;ppl/cv/aarch64/addweighted.h&gt;
...
*
*     ppl::cv::aarch64::AddWeighted<float, 3>(H, W, W * C, dev_iImage0, 1.0, W * C, dev_iImage1, 1.0, 0.0, W * C, dev_oImage);
*
*     free(dev_iImage0);
*     free(dev_iImage1);
*     free(dev_oImage);
